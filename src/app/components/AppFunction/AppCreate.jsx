...
function AppCreate() {
  ...
  const createData = async () => {
    try {
      let data = { ...formData };
      setLoading(true);
      let result = await axios.post("https://reqres.in/api/users", data);
      console.log(result);
      setTimeout(() => {
        setLoading(false);
        setAlert(true);
    ...
    <div className="md:container md:mx-auto mt-10">
      ...
      {alert && (
        ...
        >
          ...
          <div>
            <span class="font-medium">Success create data!</span> Change a few things
      ...
      <div className="mb-10 text-center">
        <h1 className="font-semibold text-xl">Form Input Karyawan</h1>
      </div>
